...
// NewRoleClone request
func NewRoleClone() *RoleClone {
	return &RoleClone{}
}

// Auditable returns all auditable/loggable parameters
func (r RoleClone) Auditable() map[string]interface{} {
	return map[string]interface{}{
		"roleID":        r.RoleID,
...
// Auditable returns all auditable/loggable parameters
func (r RoleClone) GetRoleID() uint64 {
	return r.RoleID
}

// Auditable returns all auditable/loggable parameters
func (r RoleClone) GetCloneToRoleID() []string {
	return r.CloneToRoleID
}

// Fill processes request and fills internal variables
func (r *RoleClone) Fill(req *http.Request) (err error) {
